...
<template>
  <p>
    <ak-checkbox v-model="checkbox1" :disabled="true">选项1</ak-checkbox>
    {{ checkbox1 }}
  </p>
  <p>
    <ak-checkbox v-model="checkbox2" :disabled="true">选项2</ak-checkbox>
    {{ checkbox2 }}
  </p>
</template>
<script lang="ts" setup>
...
<template>
  <p>已选值：{{ checkbox }}</p>
  <p>
    <ak-checkbox-group v-model="checkbox" :options="groupData" />
  </p>
</template>
<script lang="ts" setup>
  import { ref } from 'vue'
...
<template>
  <p>当前选中值：{{ checkbox }}</p>
  <p>
    <ak-checkbox v-model="checkbox" value="a1">选项1</ak-checkbox>
  </p>
  <p>
    <ak-checkbox v-model="checkbox" value="a2">选项2</ak-checkbox>
  </p>
  <p>
    <ak-checkbox v-model="checkbox" value="a3">选项3</ak-checkbox>
  </p>
  <p>
    <ak-checkbox v-model="checkbox" value="a4">选项4</ak-checkbox>
  </p>
  <p>
    <ak-button @click="checkbox = ['a1', 'a2', 'a3', 'a4']">全选</ak-button>
    <ak-button @click="checkbox = []">全不选</ak-button>
  </p>
</template>
<script lang="ts" setup>
  import { ref } from 'vue'
...
<template>
  <p>
    <ak-checkbox v-model="checkbox" value="a1" :beforeChange="beforeChange"
      >选项1</ak-checkbox
    >
  </p>
  <p>
